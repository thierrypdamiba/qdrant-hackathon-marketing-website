            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="text-center max-w-2xl mx-auto">
                ...
                <div className="mt-6 flex justify-center">
                  <a href="#workshops" className="bg-[#DC244C] text-white px-6 py-2.5 rounded-full font-medium hover:bg-red-700 transition-colors text-lg inline-block">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[#DC244C]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-10">
            ...
            <div className="bg-white rounded-2xl p-10 shadow-lg">
              <h4 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 text-center">Participation Prizes/Raffles</h4>
              <p className="text-lg text-gray-600 mb-8 text-center">Must submit to be eligible — $500 total</p>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
                <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-xl p-6 text-center border border-gray-200">
                  ...
                  <div className="text-lg font-bold text-gray-900 mb-2">Apple AirPods Pro</div>
                  <div className="text-base font-semibold text-[#DC244C] mb-1">$249 value</div>
                  <div className="text-sm text-gray-600">1 winner</div>
                </div>
                <div className="bg-gradient-to-br from-gray-50 to-red-50 rounded-xl p-6 text-center border border-gray-200">
                  <div className="text-4xl mb-3">🎁</div>
                  <div className="text-lg font-bold text-gray-900 mb-2">Qdrant Swag Stack</div>
                  <div className="text-base font-semibold text-[#DC244C] mb-1">$150 value</div>
                  <div className="text-sm text-gray-600">1 winner</div>
                </div>
                <div className="bg-gradient-to-br from-gray-50 to-green-50 rounded-xl p-6 text-center border border-gray-200">
                  <div className="text-4xl mb-3">💳</div>
                  <div className="text-lg font-bold text-gray-900 mb-2">Digital Gift Card</div>
                  <div className="text-base font-semibold text-[#DC244C] mb-1">$150 value</div>
                  <div className="text-sm text-gray-600">1 winner</div>
                </div>
                <div className="bg-gradient-to-br from-gray-50 to-green-50 rounded-xl p-6 text-center border border-gray-200">
